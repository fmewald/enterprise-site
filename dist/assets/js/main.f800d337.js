...
(function () {
  ...
  var ORIGINS = {
    index: { path: '/', title: 'Página inicial' },
    blog: { path: '/blog', title: 'Blog' },
    'clinicas-saude': { path: '/contabilidade-para-clinicas-e-medicos', title: 'Contabilidade para clínicas e médicos' },
    'construcao-civil': { path: '/contabilidade-para-construcao-civil', title: 'Contabilidade para construção civil' },
    'prestadores-servico': { path: '/contabilidade-para-prestadores-de-servico', title: 'Contabilidade para prestadores de serviço' },
    transportadoras: { path: '/contabilidade-para-transportadoras', title: 'Contabilidade para transportadoras' },
    contato: { path: '/contato', title: 'Contato' },
    'gestao-financeira': { path: '/gestao-financeira', title: 'Gestão financeira' },
    planos: { path: '/planos', title: 'Planos contábeis' },
    'politica-privacidade': { path: '/politica-de-privacidade', title: 'Política de Privacidade' },
    post: { path: '/blog', title: 'Conteúdo do blog' },
    'reforma-tributaria': { path: '/reforma-tributaria', title: 'Reforma Tributária' },
    segmentos: { path: '/segmentos', title: 'Segmentos atendidos' },
    servicos: { path: '/servicos', title: 'Serviços contábeis' },
    sobre: { path: '/sobre', title: 'Sobre a Enterprise' }
  };
  ...
  /* ---------- Netlify Identity somente para fluxos administrativos ---------- */
  function loadIdentityForAdminToken() {
    var hash = window.location.hash || '';
    if (!/(invite_token|recovery_token|confirmation_token)=/i.test(hash)) return;
    var script = document.createElement('script');
    script.src = 'https://identity.netlify.com/v1/netlify-identity-widget.js';
    script.async = true;
    script.onload = function () {
      if (!window.netlifyIdentity) return;
      window.netlifyIdentity.on('init', function () { window.netlifyIdentity.open(); });
      window.netlifyIdentity.init();
    };
    document.head.appendChild(script);
  }

  loadIdentityForAdminToken();
